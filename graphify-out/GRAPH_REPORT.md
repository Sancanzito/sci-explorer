# Graph Report - sci-hub  (2026-06-19)

## Corpus Check
- 480 files · ~790,360 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3162 nodes · 3152 edges · 402 communities (348 shown, 54 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca26ae97`
...
4. `command: "npx eslint --fix $FILE 2>/dev/null || true"` - 28 edges
5. `StatsEngine` - 24 edges
6. `get_friendly_error()` - 23 edges
7. `command: "npx eslint --fix $FILE 2>/dev/null || true"` - 23 edges
8. `compilerOptions` - 21 edges
9. `DataPayload` - 19 edges
10. `command: "npx eslint --fix $FILE 2>/dev/null || true"` - 18 edges

## Surprising Connections (you probably didn't know these)
- `StateComparison()` --calls--> `useTheme()`  [INFERRED]
  src/Articles/ParticleModelOfMatter/Animation.jsx → src/ThemeProvider.jsx
- `HeatingSimulation()` --calls--> `useTheme()`  [INFERRED]
  src/Articles/ParticleModelOfMatter/Animation.jsx → src/ThemeProvider.jsx
- `ComponentGenerator()` --calls--> `useTheme()`  [INFERRED]
  src/Articles/ParticleModelOfMatter/ComponentGenerator.jsx → src/ThemeProvider.jsx
- `ParticleModelScroll()` --calls--> `useTheme()`  [INFERRED]
  src/Articles/ParticleModelOfMatter/ParticleModelScroll.jsx → src/ThemeProvider.jsx
- `AppContent()` --calls--> `useTheme()`  [EXTRACTED]
  src/App.jsx → src/ThemeProvider.jsx

## Import Cycles
- None detected.

## Communities (402 total, 54 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (93): dependencies, bootstrap, canvas-confetti, cesium, convert, convert-units, cors, date-fns (+85 more)
...
Cohesion: 0.05
Nodes (12): applyPValueCorrection(), ColumnSelectionModal(), CorrelationHeatmap(), DialogConfig, locales, SelectionMode, StatisticalTool(), StatsEngine (+4 more)
...
Cohesion: 0.13
Nodes (35): Any, AnalysisPayload, apply_transform(), bootstrap_mean_diff(), check_assumptions(), clean_data(), DataPayload, get_ancova() (+27 more)
...
Cohesion: 0.06
Nodes (33): Anti-Patterns and Extended Examples, Authentication Gates, Checkpoint Types, command: "npx eslint --fix $FILE 2>/dev/null || true", Context Budget for TDD, Context Budget Rules, Context Section Rules, CRITICAL: Never Simplify User Decisions — Split Instead (+25 more)
...
Cohesion: 0.13
Nodes (15): BookLayout(), FunFacts(), KnowledgeCheck(), ScientistSpotlight(), VocabularyBuilder(), Completion(), SampleContent(), QuizBackground() (+7 more)
...
Cohesion: 0.08
Nodes (24): compilerOptions, allowImportingTsExtensions, allowJs, allowSyntheticDefaultImports, baseUrl, esModuleInterop, isolatedModules, jsx (+16 more)

### Community 20 - "Community 20"
Cohesion: 0.11
Nodes (10): ai, AIAssistant(), ChatMessage, MathToolsHub(), TectonicExplorer(), EnergySkateParkSim(), GravityOrbitsSim(), NaturalSelectionSim() (+2 more)
...
Cohesion: 0.14
Nodes (10): ScienceQuestApp(), CosmicBackground(), CoverPage(), features, HowToUse(), QuestionPlaceholder(), cards, Synopsis() (+2 more)
...
Cohesion: 0.10
Nodes (19): Allowlist escape hatch, Bad — Asking human to automate, Bad — file-wide ban unsatisfiable against a sibling's real code, Bad — JSDoc sample echoes the forbidden literal, Bad — Mixing checkpoints with implementation, Bad — Reflexive SUMMARY chaining, Bad — Too many checkpoints, Checkpoint Anti-Patterns (+11 more)

### Community 28 - "Community 28"
Cohesion: 0.18
Nodes (17): AnimatedElementCard, App(), CreatorModal(), ElementModal(), enrichElement(), getBehaviorExplanation(), getCategoryColor(), getConceptChain() (+9 more)
...
Cohesion: 0.16
Nodes (9): articlesDatabase, CUSTOM_DASHBOARDS, filterArticles(), ArticleNotFound(), ArticleReader(), ArticlesPage(), useTypewriterPlaceholder(), useArticleStore (+1 more)

### Community 31 - "Community 31"
Cohesion: 0.13
Nodes (11): BIOMES, ControlsUI(), EcoBalanceGame(), EnvironmentSystems(), getBiome(), randomNearbyPosition(), RIVER_Z_BOUNDS, SEASONS (+3 more)
...
Cohesion: 0.20
Nodes (16): App(), CalculationsModal(), EducationalSummaryScene(), GelChamber(), IntroScene(), PhaseAnalyze(), PhaseLoad(), PhasePrepare() (+8 more)
...
Cohesion: 0.19
Nodes (14): App(), formatAnalysis(), HospitalDashboard(), HospitalRoom(), LabPanel(), Leaderboard(), ObservationChecklist(), PharmacyPanel() (+6 more)

### Community 40 - "Community 40"
Cohesion: 0.16
Nodes (10): CursorGhost(), MicroscopeGame(), partGraphics, useQuizStore, CATEGORIES, quizzes, QuizBackground, QuizzesPage() (+2 more)

### Community 41 - "Community 41"
Cohesion: 0.13
Nodes (12): AnalysisService, App(), AutocompleteService, ErrorBoundary, InfoPanel(), PubChemService, QUICK_TEMPLATES, ResolverService (+4 more)
...
Cohesion: 0.16
Nodes (9): HeatingSimulation(), StateComparison(), ComponentGenerator(), MainContent(), ParticleFooter(), ParticleModelDashboard(), sections, theme (+1 more)
...
Cohesion: 0.12
Nodes (16): Building the Dependency Graph, Checkpoint Reached / Revision Complete, File Ownership for Parallel Execution, Gap Closure Plans Created Return Format, Granularity Calibration, Interface-First Task Ordering, Planner Guidance: Philosophy, Task Calibration, and Output Formats, Planning Complete Return Format (+8 more)

### Community 48 - "Community 48"
Cohesion: 0.17
Nodes (8): Chemfooter(), AtomicEvolution(), BondFormation(), DiffusionAnimation(), ParticleAnimation(), ScrollSpy(), ChemistryModelsPage(), MainContent()
...
Cohesion: 0.17
Nodes (8): EmergencySimulator(), scenarios, LabSafetyFooter(), LabSafetyPage(), LabSafetyScrollSpy(), PPEEquipper(), questions, SafetyQuizComponent()
...
Cohesion: 0.13
Nodes (5): AppContext, PLANET_KEYS, SolarSystemObservatory(), SYSTEM_DATA, useAppStore()
...
Cohesion: 0.23
Nodes (11): ACHIEVEMENTS, COLONY_APPEARANCES, CORRECT_MEDIA_MAP, DIAGNOSTIC_ACCURACY_THRESHOLDS, DISEASES, DRUG_CLASS_MATCHING, DURATIONS, MEDIA_OPTIONS (+3 more)
...
Cohesion: 0.21
Nodes (9): navigationItems, sections, slugify(), BookReaderLayout(), modalPlaceholders, sidebarControls, sectionGradients, SectionPage() (+1 more)

### Community 68 - "Community 68"
Cohesion: 0.15
Nodes (3): DNAextraction(), INITIAL_STATE, PHASES
...
Cohesion: 0.22
Nodes (6): CATEGORIES, simulationsData, SimulationsPage(), AmbientBackground(), BlackHoleFooterCanvas(), DataOrbCanvas()
...
Cohesion: 0.18
Nodes (10): name, private, scripts, build, dev, lint, preview, vercel-build (+2 more)
...
Cohesion: 0.20
Nodes (9): Backend Setup, Environment Variables, Expanding the ESLint configuration, Frontend Setup, Getting Started, Prerequisites, Production Build, React Compiler (+1 more)
...
Cohesion: 0.33
Nodes (6): CameraControlPanel(), CellExplorer(), OrganelleCarousel(), organelles, SceneControls(), useCellStore
...
Cohesion: 0.28
Nodes (4): SciSkillsFooter(), SciSkillsScrollSpy(), InvestigationPage(), sections
...
Cohesion: 0.36
Nodes (4): Markdown(), SolutionFooter(), SolutionScroll(), SolutionsMain()
...
Cohesion: 0.29
Nodes (4): ARTICLES, CATEGORIES, HomePage(), SIMULATIONS
...
Cohesion: 0.47
Nodes (3): AcidsFooter(), AcidsMain(), AcidsScroll()
...
## Knowledge Gaps
- **2027 isolated node(s):** `_runtime-launcher.snippet.sh script`, `fs`, `path`, `{ isSemverNewer }`, `{ checkLatestVersion }` (+2022 more)
...
- **Why does `useTheme()` connect `Community 16` to `Community 67`, `Community 70`, `Community 40`, `Community 137`, `Community 45`, `Community 20`, `Community 25`, `Community 30`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `MicroscopeScene` connect `Community 64` to `Community 58`, `Community 39`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Are the 4 inferred relationships involving `useTheme()` (e.g. with `HeatingSimulation()` and `StateComparison()`) actually correct?**
