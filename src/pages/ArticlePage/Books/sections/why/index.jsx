...
export function WhySection() {
  ...
  return (
    <BookLayout prevPage="/science-quest/table-of-contents" nextPage="/science-quest/when">
      <div className={`min-h-screen p-8 bg-gradient-to-br from-red-900 to-orange-900 text-white ${isDarkMode ? 'dark:bg-gradient-to-br from-gray-900 to-gray-800' : ''}`}>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className={`bg-white/10 backdrop-blur-lg p-6 rounded-2xl border border-white/20 ${isDarkMode ? 'dark:bg-gray-800/10 dark:border-gray-700' : ''}`}>
                ...
                <p className="text-lg">
                  This section explores the causes and explanations behind natural events.
                </p>
              </div>
            </div>
          </motion.div>
